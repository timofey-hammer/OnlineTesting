...
namespace DAL.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Interviews_DateCompleted",
                table: "Interviews",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Results_InterviewId_QuestionId",
                table: "Results",
                columns: new[] { "InterviewId", "QuestionId" });
            ...
            migrationBuilder.InsertData(
                table: "Surveys",
                columns: new[] { "SurveyId", "Title", "Description", "DateCreated" },
                values: new object[] { 1, "Анкета при приеме на работу", "Анкета для трудоустройства, чтобы получить дополнительные сведения о соискателе.", DateTime.UtcNow });

            migrationBuilder.InsertData(
                table: "Questions",
                columns: new[] { "QuestionId", "Text", "SurveyId" },
                values: new object[,]
                {
            ...
            migrationBuilder.InsertData(
                table: "Answers",
                columns: new[] { "AnswerId", "Text", "QuestionId" },
                values: new object[,]
                {
                    { 1, "Junior", 1 },
                    { 2, "Middle", 1 },
